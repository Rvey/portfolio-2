const ContactMe = () => {
  return (
    <section
      id="contact"
      className="text-gray-400 body-font lg:h-screen flex items-center  "
    >
      <div className=" px-5 py-24 mx-auto">
        <div className="flex flex-col text-center w-full mb-12">
          <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-white text-center mt-32 lg:mt-0">
            Contact Me
          </h1>
          <p className="w-10 h-2 bg-yellow-300 mx-auto rounded-md"></p>
        </div>
          ...
          <div className="flex flex-wrap -m-2">
            ...
            <div className="p-2 w-full pt-8 mt-8 border-t border-gray-800 text-center">
              ...
              <span className="inline-flex">
                <a
                  className="ml-4 text-gray-500 w-8 cursor-pointer"
                  href="https://github.com/Rvey"
                >
                ...
                <a className="ml-4 text-gray-500 w-8 cursor-pointer" href="https://www.linkedin.com/in/redouane-bouabana/">
                  <svg viewBox="0 0 128 128">
                    <path
                      fill=""
