  ...
  return (
    <div className="relative container mx-auto px-4 pb-24 md:pb-64">
      <div className="relative max-w-6xl mx-auto space-y-12">
        ...
        <Link
          className="inline-flex items-center py-4 px-6 bg-yellow-500 hover:bg-yellow-400 transform duration-200 cursor-pointer ml-3"
          to="contact" spy={true} smooth={true}
        >
          <svg
            className="mr-3"
          ...
          <span className="text-sm uppercase font-heading ">Download cv</span>
        </Link>
      </div>
    </div>
  );
